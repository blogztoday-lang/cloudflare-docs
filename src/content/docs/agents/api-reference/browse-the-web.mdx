...
Give your agents full access to the [Chrome DevTools Protocol (CDP)](/browser-rendering/cdp/) with [Browser Run](/browser-rendering/) tools. <InlineBadge preset="beta" />
...
Add the Browser Run and Worker Loader bindings to your wrangler configuration:
...
If you prefer to control the browser programmatically without LLM-generated code, you can use Puppeteer with the [Browser Run](/browser-rendering/) API directly.
